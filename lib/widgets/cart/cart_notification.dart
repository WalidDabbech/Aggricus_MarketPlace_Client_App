                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text('${_cartProvider.subTotal.toStringAsFixed(0)} DT' , style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                      ],
                    ),
                    if(_cartProvider.document != null)
                    if(_cartProvider.document!.exists)
                    Text('From ${_cartProvider.document!['shopName']}' ,style: TextStyle(color: Colors.white,fontSize: 10),),
