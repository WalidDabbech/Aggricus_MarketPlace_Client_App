...
class CouponWidget extends StatefulWidget {
  ...
  const CouponWidget(this.couponVendor);
            ...
            child: Padding(
              ...
              child: DottedBorder(
                child: Padding(
                  ...
                  child: Stack(
                    children: [
                        if (_coupon.document != null) Container(
    ...
    showCupertinoDialog(
      ...
      builder: (BuildContext context){
        return CupertinoAlertDialog(
          ...
          content: Text('This discount coupon $code you have entered is $validity. Please try with an other code'),
          actions: [
            TextButton(
              onPressed: (){
